...
#import "SecondHouseInfo.h"

@implementation SecondHouseInfo
...
{
    UIView *detailView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 250)];
    UIImageView *detailBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 258)];
    ...
    CSLinearLayoutView *realDetailView = [[CSLinearLayoutView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 258)];
