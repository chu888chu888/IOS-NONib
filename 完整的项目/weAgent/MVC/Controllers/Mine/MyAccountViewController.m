...
@interface MyAccountViewController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, VPImageCropperDelegate>
...
//        UIImage * image = [UIImage imageNamed:@"image.jpg"];
        [uy uploadFile:self.portraitImageView.image saveKey:[self getSaveKey]];
...
//    NSDate *d = [NSDate date];
    return [NSString stringWithFormat:@"/accountAvatar/%.0f.jpg",[[NSDate date] timeIntervalSince1970]];
