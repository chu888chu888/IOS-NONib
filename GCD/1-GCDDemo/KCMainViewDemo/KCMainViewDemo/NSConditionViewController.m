...
@synthesize imageNames,currentIndex;
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)createImageName{
    ...
    if (imageNames.count>0) {
        NSLog(@"createImageName wait, current:%i",currentIndex);
        [condition wait];
    }else{
        NSLog(@"createImageName work, current:%i",currentIndex);
        //生产者，每次生产1张图片
        [imageNames addObject:[NSString stringWithFormat:@"http://images.cnblogs.com/cnblogs_com/kenshincui/613474/o_%i.jpg",currentIndex++]];
