...
- (void)addAdView
{
    ...
    _imagePager.frame = CGRectMake(0, 0, [UIView globalWidth], 180);
...
- (void)addContactView
{
    ...
    [_contactView addSubview:_phone];
    ...
    [_contactView addSubview:_time];
    
    
    
    _givePhoneCopy = [[UIButton alloc] initWithFrame:CGRectMake([UIView globalWidth]-125, 10, 110, 30)];
    ...
    [_contactView addSubview:_givePhoneCopy];
    
    
    self.linearLayoutItem = [CSLinearLayoutItem layoutItemForView:_contactView];
    self.linearLayoutItem.padding = CSLinearLayoutMakePadding(0.0, 0.0, 0.0, 0.0);
    [self.linearLayoutView addItem:self.linearLayoutItem];
...
{
    UIView *detailView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 200)];
    UIImageView *detailBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 200)];
    ...
    CSLinearLayoutView *realDetailView = [[CSLinearLayoutView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 200)];
    
    _title = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-40, 20)];
    [_title setText:@"暂无标题"];
...
- (void)addValidView
{
    UIView *validView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 95.0)];
    
    UIImageView *validBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 95.0)];
    [validBgView setImage:[[UIImage imageNamed:@"bg_hotTopicList_cell"] beResize]];
    [validView addSubview:validBgView];
    
    CSLinearLayoutView *validDetailView = [[CSLinearLayoutView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 95.0)];
    [validView addSubview:validDetailView];
    
    
    self.linearLayoutItem = [CSLinearLayoutItem layoutItemForView:validView];
    self.linearLayoutItem.padding = CSLinearLayoutMakePadding(15.0, 0.0, 0.0, 0.0);
    [self.linearLayoutView addItem:self.linearLayoutItem];
    
    
    
    
    _validTitleView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 20.0)];
    ...
    float tempWidth = [UIView globalWidth]/4-10;
    UILabel *visitLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.0, 0.0, tempWidth, 18)];
    visitLabel.text = @"被查看";
    ...
    UILabel *collectLabel = [[UILabel alloc] initWithFrame:CGRectMake(10+tempWidth, 0.0, tempWidth, 18)];
    ...
    UILabel *callLabel = [[UILabel alloc] initWithFrame:CGRectMake(10+2*tempWidth, 0.0, tempWidth, 18)];
    callLabel.text = @"被拨打";
    callLabel.textAlignment = NSTextAlignmentCenter;
    callLabel.font = [UIFont baseWithSize:12];
    callLabel.textColor = [UIColor grayColor];
    
    UILabel *blackLabel = [[UILabel alloc] initWithFrame:CGRectMake(10+3*tempWidth, 0.0,tempWidth, 18)];
    blackLabel.text = @"被举报";
    ...
    UIView *validLableView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 18)];
    ...
    _visitNum = [[UILabel alloc] initWithFrame:CGRectMake(10.0, 0.0, tempWidth, 18)];
    _visitNum.text = @"23";
    _visitNum.textAlignment = NSTextAlignmentCenter;
    _visitNum.font = [UIFont baseWithSize:12];
    _visitNum.textColor = [UIColor baseColor];
    
    _collectNum = [[UILabel alloc] initWithFrame:CGRectMake(10+tempWidth, 0.0, tempWidth, 18)];
    _collectNum.text = @"11";
    ...
    _callNum = [[UILabel alloc] initWithFrame:CGRectMake(10+2*tempWidth, 0.0, tempWidth, 18)];
    _callNum.text = @"3";
    _callNum.textAlignment = NSTextAlignmentCenter;
    _callNum.font = [UIFont baseWithSize:12];
    _callNum.textColor = [UIColor baseColor];
    
    _blackNum = [[UILabel alloc] initWithFrame:CGRectMake(10+3*tempWidth, 0.0, tempWidth, 18)];
    _blackNum.text = @"1";
    _blackNum.textAlignment = NSTextAlignmentCenter;
    _blackNum.font = [UIFont baseWithSize:12];
    _blackNum.textColor = [UIColor baseColor];
    
    UIView *validNumView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 18)];
...
- (void)addAddressView
{
    UIView *AddressView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 90.0)];
    
    UIImageView *addressBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 90.0)];
    [addressBgView setImage:[[UIImage imageNamed:@"bg_hotTopicList_cell"] beResize]];
    [AddressView addSubview:addressBgView];
    
    CSLinearLayoutView *addressDetailView = [[CSLinearLayoutView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 90)];
    ...
    UIView *addressTitleView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 20.0)];
    ...
    UIView *locationDetail = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 40.0)];
...
//    locationLabel.textColor = [UIColor baseColor];
    ...
    _distanceLabel = [[UILabel alloc] initWithFrame:CGRectMake(22.0, 0.0, 100, 18)];
    _distanceLabel.text = @"102.3m";
//    distanceLabel.textAlignment = NSTextAlignmentCenter;
    _distanceLabel.font = [UIFont baseWithSize:10];
    ...
    UIImageView *lineItemView = [[UIImageView alloc] initWithFrame:CGRectMake([UIView globalWidth] - 80, 0.0, 1,35)];
    [lineItemView setImage:[UIImage imageNamed:@"icon_deal_verticalline"]];
    [locationDetail addSubview:lineItemView];
    
    _goView = [[UIImageView alloc] initWithFrame:CGRectMake([UIView globalWidth] - 70, 0.0, 35,35)];
    [_goView setImage:[UIImage imageNamed:@"icon_homepage_masageCategory"]];
    [locationDetail addSubview:_goView];
...
{
    UIView *describeView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 200.0)];
    
    UIImageView *describeBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 200.0)];
    [describeBgView setImage:[[UIImage imageNamed:@"bg_hotTopicList_cell"] beResize]];
    [describeView addSubview:describeBgView];
    
    CSLinearLayoutView *describeDetailView = [[CSLinearLayoutView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 200.0)];
    ...
    UIView *describeTitleView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 20.0)];
    ...
    _describe = [[UITextView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-40, 140.0)];
    _describe.text = @"暂无描述";
...
- (void)addPhoneView
{
    ...
    _givePhone = [[UIButton alloc] initWithFrame:CGRectMake([UIView globalWidth]-125, 10, 110, 30)];
...
- (void)addBlockView
{
    _blockBtn = [[UIButton alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20, 30)];
    [_blockBtn beRed];
...
- (void)addFooterView
{
    UIView *footerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth], 20)];
...
- (CSLinearLayoutItem*)makeLineViewItem
{
    ...
    UIImageView *lineView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, [UIView globalWidth]-20,1)];
...
{
    UIView *contactView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth], 50)];
    UIImageView *bgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth], 50)];
