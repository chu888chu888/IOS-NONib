...
{
    UIView *detailView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 140)];
    UIImageView *detailBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 148)];
    ...
    CSLinearLayoutView *realDetailView = [[CSLinearLayoutView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 148)];
    ...
    UIView *expectTimeView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 20)];
    ...
    UIView *expectHouseView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView globalWidth]-20, 20)];
