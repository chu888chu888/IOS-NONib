...
-(void) addSegmentedControl{
    ...
    _segmentedControl.frame = CGRectMake(10.0, 10.0,[ UIScreen mainScreen ].applicationFrame.size.width-20, 30.0);
    /*
     这个是设置按下按钮时的颜色
     */
    ...
    UIView *selectView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [ UIScreen mainScreen ].applicationFrame.size.width, 50)];
    UIImageView *bgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [ UIScreen mainScreen ].applicationFrame.size.width, 50)];
